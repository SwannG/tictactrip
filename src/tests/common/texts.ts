export const shortText: string = 'Un petit coup au carreau, comme si quelque chose l\'avait heurté, suivi d\'une ample chute légère comme des grains de sable qu\'on eut laissés tomber d\'un fenêtre au dessus, puis, la chute s\'entendant, se réglant, adoptant un rythme, devenant fluide, sonore, musicale, innombrable, universelle : c\'était la pluie.'

export const shortTextJustified: string = 'Un  petit  coup  au  carreau, comme si quelque chose l\'avait heurté, suivi d\'une\n' +
    'ample  chute  légère  comme  des  grains  de sable qu\'on eut laissés tomber d\'un\n' +
    'fenêtre  au  dessus, puis, la chute s\'entendant, se réglant, adoptant un rythme,\n' +
    'devenant fluide, sonore, musicale, innombrable, universelle : c\'était la pluie.'

export const mediumText: string = 'Et tout d\'un coup le souvenir m\'est apparu. Ce goût, c\'était celui du petit morceau de madeleine que le dimanche matin à Combray (parce que ce jour-là je ne sortais pas avant l\'heure de la messe), quand j\'allais lui dire bonjour dans sa chambre, ma tante Léonie m\'offrait après l\'avoir trempé dans son infusion de thé ou de tilleul.\n' +
    '\n' +
...
export const mediumTextJustified: string = 'Et  tout  d\'un  coup  le  souvenir m\'est apparu. Ce goût, c\'était celui du petit\n' +
    'morceau de madeleine que le dimanche matin à Combray (parce que ce jour-là je ne\n' +
    'sortais  pas avant l\'heure de la messe), quand j\'allais lui dire bonjour dans sa\n' +
    'chambre, ma tante Léonie m\'offrait après l\'avoir trempé dans son infusion de thé\n' +
    'ou de tilleul.\n' +
    'La  vue  de  la  petite madeleine me m\'avait rien rappelé avant que je n\'y eusse\n' +
    'goûté ...\n' +
    'Mais,  quand  d\'un  passé  ancien  rien  ne  subsiste,  aprés la mort des êtres,\n' +
    'après  la  destruction  des  choses, seules, plus frèles mais plus vivaces, plus\n' +
    'immatérielles,  plus  persistantes,  plus  fidèles, l\'odeur et la saveur restent\n' +
    'encore  longtemps,  comme  des  âmes,  à se rappeler, à attendre, à espérer, sur\n' +
    'la  ruine  de tout le reste, à porter sans fléchir, sur leur gouttelette presque\n' +
    'impalpable, l\'édifice immense du souvenir.'

export const longText: string = 'Longtemps, je me suis couché de bonne heure. Parfois, à peine ma bougie éteinte, mes yeux se fermaient si vite que je n’avais pas le temps de me dire: «Je m’endors.» Et, une demi-heure après, la pensée qu’il était temps de chercher le sommeil m’éveillait; je voulais poser le volume que je croyais avoir dans les mains et souffler ma lumière; je n’avais pas cessé en dormant de faire des réflexions sur ce que je venais de lire, mais ces réflexions avaient pris un tour un peu particulier; il me semblait que j’étais moi-même ce dont parlait l’ouvrage: une église, un quatuor, la rivalité de François Ier et de Charles-Quint. \n' +
    '\n' +
...
export const longTextJustified: string =
